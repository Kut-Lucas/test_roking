...
function AdminManagement() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const usersRes = await axios.get('https://41.57.106.76:8445/api/admin-management');
                const committeesRes = await axios.get('https://41.57.106.76:8445/api/committees');
                const rolesRes = await axios.get('https://41.57.106.76:8445/api/user-roles');
    ...
    const handleAddRole = async () => {
        ...
        try {
            await axios.post('https://41.57.106.76:8445/api/update-role', {
